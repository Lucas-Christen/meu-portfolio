                ...
                <div className="space-y-6 divide-y divide-primary/10">
                  <div className="flex items-center pt-4 first:pt-0">
                    ...
                    <div>
                      ...
                      <div className="text-text-secondary text-sm">{t('about.stat1')}</div>
                    </div>
                  </div>
                  <div className="flex items-center pt-4">
                    ...
                    <div>
                      ...
                      <div className="text-text-secondary text-sm">{t('about.stat2')}</div>
                    </div>
                  </div>
                  <div className="flex items-center pt-4">
                    <div className="relative mr-4">
                    ...
                    <div>
                      ...
                      <div className="text-text-secondary text-sm">{t('about.stat3')}</div>
                    </div>
                  </div>
                </div>
              </div>
